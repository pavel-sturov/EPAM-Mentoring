...
function MessageAreaForm(sendMessageToWS, notify) {
...
MessageAreaForm.prototype.addToDOM = function (userName) {
...
MessageAreaForm.prototype.displayScrollDownBtn = function () {
...
//TO SCROLL DOWN
MessageAreaForm.prototype.toScrollDown = function () {
    this.wrapper.scrollTop = this.wrapper.scrollHeight;
};

//TO SEND MESSAGES
MessageAreaForm.prototype.sendMessage = function () {
    this.sendMessageToWS(this.messageInput.value);
    this.messageInput.value = '';
};

//TO PRINT MESSAGES AT THE PAGE
MessageAreaForm.prototype.printMessage = function (data) {
