...
function StatusForm(closeWS, openWS) {
...
StatusForm.prototype.addToDOM = function (userName) {
...
StatusForm.prototype.disconnect = function () {
    this.closeWS();
    ...
    // this.logoutBtn.style.visibility = 'hidden';
};

StatusForm.prototype.logOut = function () {
...
StatusForm.prototype.connect = function () {
    this.openWS();
